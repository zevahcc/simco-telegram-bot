...
async def help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_message = (
        ...
        f"**/alert \\<price objetivo\\> \\<resourceId\\> \\[quality\\] \\[name\\]**\n"
        ...
        f"**/delete \\<id1\\> \\[id2 ... id5\\] \\[admin_code\\]**\n"
        ...
        f"**/deleteall \\[admin_code\\] \\[user_id\\]**\n"
